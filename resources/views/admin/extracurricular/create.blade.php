...
@section('title')
Tambah Ekstrakurikular
@endsection
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-1"><span class="text-muted fw-light">Ekstrakurikular Sekolah /</span> Tambah Ekstrakurikular</h4>
    <div class="row mb-3">
        <div class="offcanvas-body pt-0" id="card-block">
            <form id="create-post-form" enctype="multipart/form-data" id="card-block">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" id="submit-extracurricular" class="btn btn-primary">Simpan</button>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $('#submit-extracurricular').click(function() {
            Swal.fire({
                title: 'Yakin?',
                text: "Kamu akan menambahkan Ekstrakurikular",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('admin.extracurricular.store').'?_token='.csrf_token() }}',
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
