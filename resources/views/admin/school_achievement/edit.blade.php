...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-1"><span class="text-muted fw-light">Prestasi Sekolah /</span> Edit Prestasi</h4>
    <div class="row mb-3">
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" id="title" value="{{$school_achievement->title}}" required />
                        </div>
                    </div>
                    <div class="card mb-3">
                        <div class="card-body">
                            <label class="form-label" for="judul">Deskripsi Singkat</label>
                            <textarea name="" id="short_desc" cols="30" rows="5" class="form-control" >{{$school_achievement->short_desc}}</textarea>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
