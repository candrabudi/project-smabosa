...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-1"><span class="text-muted fw-light">Prestasi Sekolah /</span> Semua Data</h4>
            ...
            <div class="card">
                <div class="nav-align-top mb-4">
                    <div class="card-header p-3 d-flex mb-4">
                        <h5 class="align-self-center m-0">List Prestasi Sekolah</h5>
                    ...
                    <div class="card-body">
                        <div class="card-datatable table-responsive">
                            <table class="dt-responsive table" id="get-school-achievement">
                                <thead>
                                    <tr>
                                        <th width=50>No</th>
                                        <th>Judul</th>
...
<script>
    $(function() {
        var table = $('#get-school-achievement').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.school-achievement.datatable') !!}',
            columns: [
                { data: 'no'},
                { data: 'title'},
                { data: 'short_desc'},
