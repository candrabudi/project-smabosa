        ...
        <div class="col-lg-6 col-12">
            ...
            <div class="single-news custom-shadow-hover wow fadeInUp" data-wow-delay=.2s>
                ...
                <div class=content-body>
                    ...
                    <h4 class=title><a href="{{ route('announcement.detail', $announcement->slug) }}">{{ $announcement->title }}</a></h4>
                    <p><?php echo substr($announcement->short_desc, 0, 150) ?>...</p>
                    <div class=button>
                        <a href="{{ route('announcement.detail', $announcement->slug) }}" class=btn> Baca Lebih Lanjut</a>
                    </div>
                </div>
            </div>
