        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title align-center gray-bg">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay=".4s">Prestasi SMK 1 BOPKRI Yogyakarta</h2>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="info-head">
                                ...
                                <div class="info-box">
                                    ...
                                    <h4 class="name"><a href="{{route('achivement.detail', $achivement->slug)}}">{{ $achivement->title }}</a></h4>
